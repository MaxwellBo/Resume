...
\begin{detail}
	\BulletItem Primarily backend development, working with purely functional Scala (Play, Http4s, Typelevel ecosystem), and some Python
\end{detail}
...
\par Familiar: Unix, JetBrains IDEs, JavaFX, discrete mathematics, algorithms \& data structures
...
\begin{detail}
	\BulletItem \href{https://www.syncuq.com/}{University of Queensland exclusive schedule sharing platform}
