...
\begin{detail}
	\BulletItem Working with purely functional Scala (Akka, Scalaz) and TypeScript (React, Redux) in Atlassian's Identity team
\end{detail}
...
\begin{detail}
	\BulletItem Used at all internal UQUNSA Model UNs. Dramatically reduced burden on committee directors, cutting administration time by 30 minutes per day (50\%). Used at all large Australian MUNs, and over 20 international MUNs. Over 200 unique users per month
