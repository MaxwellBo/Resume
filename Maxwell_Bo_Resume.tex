...
\begin{detail}
	...
	TypeScript (React, RxJS, GraphQL), Ruby (Cucumber), PostgreSQL + PostGIS, C\# (Xamarin) \& Kotlin (Android), to develop a mobile workforce management platform 
...
\par Learning & Rust, Erlang, Prolog, Idris, Kotlin\\
\par Encountered & Elm, Java, C, Ruby, PostgreSQL, C++, C\#
\end{tabular}
