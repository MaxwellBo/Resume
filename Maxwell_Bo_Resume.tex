...
\par \textit{Encountered}: & Elm, Rust, Java, C
\end{tabular}
...
\begin{tabular}{rl}
\par \textit{Experienced}: & Git, React, Play, Finagle, Scala Typelevel ecosystem\\
						 & (Cats, http4s, doobie, Monix, Shapeless, circe, Scalameta, refined, Monocle)\\
\par \textit{Familiar}: & Unix, discrete mathematics, algorithms \& data structures, compilers, formal methods, formal logic\\ 
