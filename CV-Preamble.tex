...
\usepackage[
left=0.25in, % was 0.7
right=0.25in, % was 0.7
top=0.19in, % was 0.
bottom=0.13in, % was 0.55
nohead,
nofoot]{geometry}
...
\def\@oddhead{}%
\def\@evenhead{}%
\def\@oddfoot{\footnotesize\hfill{Page}~{\thepage}~of~1\hfill}%
\def\@evenfoot{\footnotesize\hfill{Page}~{\thepage}~of~1\hfill}}
\makeatother
...
\renewcommand{\section}[3]{\\[-1.55em]\pdfbookmark[2]{#2}{#3}\\%
